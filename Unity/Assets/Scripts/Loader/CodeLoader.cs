...
namespace ET
{
    public class CodeLoader: Singleton<CodeLoader>
    {
        ...
        public void LoadHotfix()
        {
            ...
            if (!Define.IsEditor)
            {
                string[] logicFiles = Directory.GetFiles("../Unity/" + Define.BuildOutputDir, "Hotfix_*.dll");
                ...
                assBytes = File.ReadAllBytes(Path.Combine("../Unity/" + Define.BuildOutputDir, $"{logicName}.dll"));
                pdbBytes = File.ReadAllBytes(Path.Combine("../Unity/" + Define.BuildOutputDir, $"{logicName}.pdb"));
